...
class ViT(nn.Module):
    def __init__(self, in_dim, out_dim, batch_size, device, patch_size, num_layers=5, dropout=0.3) -> None:
        ...
        self.configuration = ViTConfig(image_size = 72, num_channels = 1, patch_size = self.patch_size)
